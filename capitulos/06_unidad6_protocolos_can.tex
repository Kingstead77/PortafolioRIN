...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/cap6/6.1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/cap6/6.2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/cap6/6.3.png}
...
\begin{table}[H]
    ...
    \label{tab:can_trama}
    \begin{tabularx}{\textwidth}{@{}l>{\centering\arraybackslash}p{1.8cm}X@{}}
        \toprule
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/cap6/6.4.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/cap6/6.5.png}
