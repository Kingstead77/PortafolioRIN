...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{assets/cap1/figura1_1.jpeg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{assets/cap1/figura1_2.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{assets/cap1/manchester.png}
...
En RZ, la señal vuelve a cero (o al nivel de referencia) en la \textbf{mitad} del periodo de bit, independientemente del valor transmitido. Por ejemplo, un ``1'' se representa como un pulso positivo seguido de un retorno a cero, y un ``0'' como un pulso negativo seguido de retorno a cero (en RZ bipolar). Aunque simplifica la sincronización, consume más ancho de banda y requiere tres niveles de tensión, lo que complica los circuitos.

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{assets/cap1/topologias.png}
\caption{Ejemplo de codificación RZ unipolar y bipolar}
\label{fig:codificacion-rz}
\end{figure}

\subsection{AMI (Alternate Mark Inversion)}

AMI es una codificación de tres niveles en la que los ``0'' se transmiten como nivel cero, mientras que los ``1'' (marcas) alternan entre polaridad positiva y negativa. Esta alternancia elimina la componente continua y permite detectar errores de transmisión: si el receptor observa dos marcas consecutivas del mismo signo, sabe que ha ocurrido un error. AMI se utiliza en sistemas de telecomunicaciones tradicionales (T1/E1).

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{assets/cap1/noBalanceada.png}
\caption{Ejemplo de codificación AMI}
\label{fig:codificacion-ami}
\end{figure}
...
NRZ-I & Sólo en unos (con bit stuffing) & Sí & USB \\
Manchester & Garantizadas (1/bit) & No & Ethernet 10BASE-T \\
RZ & Garantizadas (retorno a cero) & No (bipolar) & Canales de fibra óptica antiguos \\
AMI & En marcas (alternadas) & No & T1/E1, telecomunicaciones \\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{assets/cap1/estructuraTrama.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{assets/cap1/master-slave.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{assets/cap1/csma.png}
\caption{Medios de transmisión físicos más comunes en comunicaciones serie}
\label{fig:medios}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{assets/cap1/tdma.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{assets/cap1/diagramaPines.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{assets/cap1/conectorUSB.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{assets/cap1/dte-dte.png}
