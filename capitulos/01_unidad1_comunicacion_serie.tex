...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir fotografía/esquema conceptual del envío de información entre dos dispositivos (transmisor → medio → receptor)}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir esquema/diagrama comparativo: arriba 8 líneas de datos en paralelo (bus ancho), abajo 1 línea de datos en serie (bus estrecho). Indicar que ambos transmiten el mismo byte.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama de tiempos de una codificación NRZ mostrando la secuencia de bits 0101100 y su correspondiente forma de onda.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama de tiempos de una codificación NRZ bipolar mostrando la secuencia de bits 0101100 con niveles positivos y negativos.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama de tiempos comparativo NRZ vs. NRZ-I para la misma secuencia de bits.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama de tiempos de codificación RZ unipolar para una secuencia de bits.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama de tiempos de codificación RZ bipolar para una secuencia de bits.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama de tiempos de codificación Manchester para la secuencia de bits 0101. Indicar las transiciones en el centro de cada bit.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama con las 4 topologías básicas: punto a punto, bus, estrella y anillo. Usar iconos simples de dispositivos.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama comparativo: a) Conexión no balanceada (1 señal + GND) con ruido añadido. b) Conexión balanceada (2 señales opuestas) mostrando cómo el ruido común se cancela al restar.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir fotografía de un cable coaxial con su conector y la estructura interna (conductor central, aislante, malla, cubierta).}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir fotografía de un cable de par trenzado (UTP/STP) mostrando los pares retorcidos y el conector RJ-45.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir fotografía de un cable de fibra óptica con sus conectores (SC, LC o ST) y el núcleo de vidrio.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama de tiempos: línea de datos con nivel alto (idle), transición a bajo (start bit), 8 bits de datos, bit de paridad opcional, y bit de parada (stop bit) a nivel alto.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama de bloques de una trama genérica: [START/Delimitador] [Dirección] [Datos (N bytes)] [CRC/BCC] [STOP/Delimitador] con anotaciones de tamaño.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama de un bus maestro--esclavo con un maestro central y tres esclavos conectados.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama de tiempos mostrando dos nodos CSMA que detectan una colisión y retrasan su retransmisión.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama de un ciclo TDMA con cuatro nodos y sus respectivas franjas horarias (slots).}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama de conexión DTE $\leftrightarrow$ DCE mediante RS-232, mostrando los roles de cada extremo.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama de los pines de un conector DB-9 macho y hembra, señalando TXD, RXD y GND.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama de un conector USB tipo A con la numeración de pines y colores de cable.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama de conexión entre dos dispositivos UART: Dispositivo A (TX $\rightarrow$ RX B) y Dispositivo B (TX $\rightarrow$ RX A), con GND común. Indicar ``conexión cruzada''.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama de tiempos detallado de una trama UART (ejemplo: 8N1). Mostrar: nivel alto idle, start bit a bajo, bits D0 a D7 (LSB primero), stop bit a alto. Anotar duración de cada segmento en tiempo de bit.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir fotografía de la pantalla de un osciloscopio mostrando la señal de un byte transmitido por UART. Señalar visualmente el start bit, los bits de datos, y el stop bit.}\vspace{1.5cm}}}
\caption{Captura de osciloscopio de una trama UART real (ejemplo del carácter 'A')}
\label{fig:osciloscopio-uart}
\end{figure}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir diagrama de tiempos de las señales RTS y CTS en una comunicación UART con control de flujo.}\vspace{1.5cm}}}
\caption{Secuencia de control de flujo por hardware (RTS/CTS) en UART}
\label{fig:rts-cts}
\end{figure}

\subsubsection{Panorama de interfaces seriales}

El UART es solo una de muchas interfaces serie disponibles. En la siguiente tabla se resumen las más relevantes para el ámbito de la Informática Industrial y Robótica:

\begin{table}[htbp]
\centering
\small
\caption{Interfaces seriales más comunes en sistemas embebidos e industriales}
\begin{tabularx}{\textwidth}{@{}lXXXX@{}}
\toprule
\textbf{Interfaz} & \textbf{Modo} & \textbf{Balanceada} & \textbf{Máx. velocidad} & \textbf{Uso típico} \\
\midrule
UART & Asíncrono, P2P & No (TTL) & $<$1 Mb/s & Debug, sensores, GPS \\
SPI & Síncrono, maestro/esclavo & No & $<$50 Mb/s & Memoria, pantallas, SD \\
I2C & Síncrono, multi-esclavo & No & $<$3.4 Mb/s & Sensores, EEPROM \\
RS-232 & Asíncrono, P2P & No & 115.2 kb/s & Módems, periféricos antiguos \\
RS-485 & Asíncrono, bus & Sí (diferencial) & 10 Mb/s & Automatización, PLCs \\
CAN & Asíncrono, bus & Sí (diferencial) & 1 Mb/s & Automoción, maquinaria \\
USB & Síncrono, maestro/esclavo & Sí (diferencial) & 20 Gb/s (USB4) & Periféricos, carga \\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir fotografía del ESP32-S3-DevKitC-1 señalando los pines UART1 (GPIO 17, 18, 19, 20).}\vspace{1.5cm}}}
\caption{Placa ESP32-S3-DevKitC-1 con indicación de los pines UART utilizados}
\label{fig:esp32-pines}
\end{figure}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir captura de pantalla del código Python para envío por serial, o del IDE Arduino con el código ESP32.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir fotografía de la pantalla del osciloscopio con la señal decodificada del carácter 'A'. Añadir anotaciones sobre los bits.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir fotografía del montaje físico: ESP32 conectada al cable USB-TTL, y este al PC. Mostrar los cables TX, RX y GND conectados.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir captura de pantalla del monitor serie del Arduino IDE o terminal Python mostrando el intercambio de datos entre PC y ESP32.}\vspace{1.5cm}}}
\caption{Resultado de la comunicación bidireccional PC $\leftrightarrow$ ESP32}
\label{fig:comunicacion-pc-esp32}
\end{figure}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir fotografía del montaje físico: dos ESP32-S3 conectadas entre sí, mostrando el cruce TX-RX y GND común.}\vspace{1.5cm}}}
\caption{Montaje físico de dos ESP32-S3 conectadas en comunicación serie directa}
\label{fig:montaje-esp32-doble}
\end{figure}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir fotografía de la pantalla del osciloscopio mostrando la señal del carácter 'S' con los bits anotados.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir fotografía de la pantalla del osciloscopio mostrando las medidas de tensión (Vhigh, Vlow, Vpp).}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir fotografía del montaje con adaptadores TTL-RS-232 y cable null-modem.}\vspace{1.5cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}\textit{TODO: Añadir esquema resumen/mapa conceptual de la Unidad 1: comunicación serie, medios, sincronización, UART, práctica.}\vspace{1.5cm}}}
\caption{Mapa conceptual resumen de la Unidad 1}
\label{fig:mapa-unidad1}
\end{figure}
